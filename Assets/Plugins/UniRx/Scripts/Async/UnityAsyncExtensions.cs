...
namespace UniRx.Async
{
    public static partial class UnityAsyncExtensions
    {
        ...
        {
            Error.ThrowArgumentNullException(assetBundleCreateRequest, nameof(assetBundleCreateRequest));
            return new AssetBundleCreateRequestAwaiter(assetBundleCreateRequest);
        }

        public static UniTask<UnityEngine.Object> ToUniTask(this AssetBundleCreateRequest assetBundleCreateRequest)
        {
            Error.ThrowArgumentNullException(assetBundleCreateRequest, nameof(assetBundleCreateRequest));
            return new UniTask<UnityEngine.Object>(new AssetBundleCreateRequestAwaiter(assetBundleCreateRequest));
        }

        public static UniTask<UnityEngine.Object> ConfigureAwait(this AssetBundleCreateRequest assetBundleCreateRequest, IProgress<float> progress = null, PlayerLoopTiming timing = PlayerLoopTiming.Update, CancellationToken cancellation = default(CancellationToken))
        {
            Error.ThrowArgumentNullException(assetBundleCreateRequest, nameof(assetBundleCreateRequest));

            var awaiter = new AssetBundleCreateRequestConfiguredAwaiter(assetBundleCreateRequest, progress, cancellation);
            if (!awaiter.IsCompleted)
            {
                PlayerLoopHelper.AddAction(timing, awaiter);
            }
        ...
        public static AssetBundleRequestAwaiter GetAwaiter(this AssetBundleRequest assetBundleRequest)
        {
        ...
        public static UniTask<UnityEngine.Object> ToUniTask(this AssetBundleRequest assetBundleCreateRequest)
        {
            Error.ThrowArgumentNullException(assetBundleCreateRequest, nameof(assetBundleCreateRequest));
            return new UniTask<UnityEngine.Object>(new AssetBundleRequestAwaiter(assetBundleCreateRequest));
        }

        public static UniTask<UnityEngine.Object> ConfigureAwait(this AssetBundleRequest assetBundleRequest, IProgress<float> progress = null, PlayerLoopTiming timing = PlayerLoopTiming.Update, CancellationToken cancellation = default(CancellationToken))
        {
            Error.ThrowArgumentNullException(assetBundleRequest, nameof(assetBundleRequest));

            var awaiter = new AssetBundleRequestConfiguredAwaiter(assetBundleRequest, progress, cancellation);
            if (!awaiter.IsCompleted)
            {
                PlayerLoopHelper.AddAction(timing, awaiter);
            }
...
#pragma warning restore CS0618
        ...
        public struct AssetBundleCreateRequestAwaiter : IAwaiter<UnityEngine.Object>
        {
        ...
        class AssetBundleCreateRequestConfiguredAwaiter : IAwaiter<UnityEngine.Object>, IPlayerLoopItem
        {
            AssetBundleCreateRequest asyncOperation;
            IProgress<float> progress;
            CancellationToken cancellationToken;
